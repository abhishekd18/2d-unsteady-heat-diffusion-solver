...
void inputSettings::readSettingsFile()
{
    ...
    cout << "Name of the mprm file                   : " << mprmFile  << endl;
    cout << "Name of the nprm file                   : " << nprmFile  << endl;
    ...
    cout << "Type and value of BC on FG5             : " << BC[5].BCType << " " << BC[5].BCValue << endl;
    cout << "Type and value of BC on FG6             : " << BC[6].BCType << " " << BC[6].BCValue << endl;
    cout << endl << endl;
