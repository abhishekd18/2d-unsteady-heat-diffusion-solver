...
class inputSettings
{
	...
	string	wdir;	    // working directory
        ...
        string  restart;    // restart file writing (yes/no)
	double	scale;      // scaling factor for dimensions (mm to m or vice versa)
    ...
    public:
        ...
        string          getRestart()    {return restart;};
